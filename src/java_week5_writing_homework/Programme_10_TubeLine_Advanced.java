...
public class Programme_10_TubeLine_Advanced {
    public static void main(String[] args) {
        //All stations in Zone1
        String stations[] = ("Aldgate,Angle,Baker Street,Bank,Barbican,bayswater,blackfriars,bond street," +
        ...
        //Multidimensional array of TubeLines and Stations
        ...
        do {
            ...
            for (int i = 0; i < stations.length; i++) {
                if (str.equalsIgnoreCase(stations[i])) {
                    c = stations[i];
                }
            }
